...
/**
 * This class implements the spread metric. It can be used also as command line
 * program just by typing "java Spread <solutionFrontFile> <trueFrontFile>".
 * This metric is only applicable to two bi-objective problems. Reference: Deb,
 * K., Pratap, A., Agarwal, S., Meyarivan, T.: A fast and elitist multiobjective
 * genetic algorithm: NSGA-II. IEEE Trans. on Evol. Computation 6 (2002) 182-197
 */
public class Spread
{
	static MetricsUtil utils_;// utils_ is used to
