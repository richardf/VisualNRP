...
public class Neighborhood
{
	...
	/**
	 * Stores the neighborhood. structure_ [i] represents a neighborhood for a
	 * solution. structure_ [i][j] represents a neighborhood with a ratio.
	...
	/**
	 * Enum type for defining the North, South, East, West, North-West,
	 * South-West, North-East, South-East neighbor.
	 */
	enum Row
	{
		N, S, E, W, NW, SW, NE, SE
	...
	public Neighborhood(int solutionSetSize)
	{
		...
		// For each individual, and different rates the individual has a
		// different
